    ...
    <div className={styles.aboutPage}>
      ...
      <section>
        ...
        <p>
          ...
          me petting my cats or indulging in one of my hobbies, such as
          photography.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          technologies and collaborate with brilliant minds. At Freenome, I
          develop backend systems that power genomic data processing,
          contributing to advancements in healthcare. Previously, at Elsevier, I
          led a team of talented engineers to create impactful products in the
          healthcare field.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          technologies. Recently, I&apos;ve been experimenting with LLMs and
          React, which has resulted in this website. Open source contributions
          are also close to my heart – I love giving back to the community and
      ...
      <section>
        ...
        <p>
          ...
          I also enjoy creating interactive data visualizations and contributing
      ...
      <section>
        ...
        <p>
          ...
          collaboration or just say hello, feel free to connect with me on{' '}
          <a href='https://www.linkedin.com/in/andrew-epstein/'>LinkedIn</a>.
        </p>
      </section>
    </div>
  );
