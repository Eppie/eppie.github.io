...
const KeyboardPage: React.FC = () => {
    const qwertyLayout: Layout = {
        "Q": [0, 1], "W": [0, 2], "E": [0, 3], "R": [0, 4], "T": [0, 5],
        "Y": [0, 6], "U": [0, 7], "I": [0, 8], "O": [0, 9], "P": [0, 10],
        "A": [1, 1], "S": [1, 2], "D": [1, 3], "F": [1, 4], "G": [1, 5],
        "H": [1, 6], "J": [1, 7], "K": [1, 8], "L": [1, 9], "Z": [2, 1],
        "X": [2, 2], "C": [2, 3], "V": [2, 4], "B": [2, 5], "N": [2, 6],
        "M": [2, 7]
    };
    ...
    useEffect(() => {
        workerRef.current = new Worker(new URL('./optimizeWorker.ts', import.meta.url));
    ...
    const handleOptimize = (): void => {
        ...
        workerRef.current?.postMessage({
            ...
            iterations,
            numRestarts,
            weights: { // Add this object with the weights
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.results}>
                <h2>Current Best Score: {bestMetricOverall === Infinity ? 'N/A' : bestMetricOverall.toFixed(2)}</h2>
